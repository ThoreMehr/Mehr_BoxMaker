...
import math
import inkex
from mehr_lib.Mehr_plate import Mehr_plate
...
#top and bottom plate
    ...
    Plate_tb=Mehr_plate((XYZ[0],XYZ[1]),tabs_tb,start_tb,thickness,kerf)#top and bottom plate
...
#left and right plate
    ...
    Plate_lr=Mehr_plate((XYZ[2],XYZ[1]),tabs_lr,start_lr,thickness,kerf)#left and right plate
    for d in Y_divisions_distances:
...
#front and back plate
    ...
    Plate_fb=Mehr_plate((XYZ[0],XYZ[2]),tabs_fb,start_fb,thickness,kerf)#font and back plate
    for d in X_divisions_distances:
      Plate_fb.add_holes('Y',d,Tabs_XYZ[2])

    Plate_xc=Mehr_plate((XYZ[2],XYZ[1]),tabs_lr,(False,False,False,False),thickness,kerf)
    for d in Y_divisions_distances:
      Plate_xc.holes+=[Plate_xc.rect([0,Plate_xc.corner_offset[1]+d+kerf],[Plate_xc.AABB[0]/2-kerf,thickness-2*kerf])]
     
    Plate_yc=Mehr_plate((XYZ[0],XYZ[2]),tabs_fb,(False,False,False,False),thickness,kerf)
    for d in X_divisions_distances:
